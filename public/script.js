                    ...
                    if(data.pass == 2){
                        $.get("/score", function(data, textStatus, xhr){
                            ...
                            if(data.score.Winner == 2){
                                document.getElementById('winnerwho').innerHTML = "Player 2 Wins!";
                            }else
                            if (data.score.Winner == 1) {
                                document.getElementById('winnerwho').innerHTML = "Player 1 Wins!";
                            }
